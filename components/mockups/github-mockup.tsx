  ...
  return (
    <div className="h-full rounded-lg border border-neutral-200 dark:border-neutral-800 overflow-hidden text-left flex flex-col [zoom:0.9]">
      ...
      <div className="flex items-center justify-between px-3 py-1.5 bg-neutral-700 dark:bg-neutral-800 text-neutral-300">
        <span className="font-semibold text-[11px] tracking-tight text-white">GitHub Gist</span>
      ...
      <div className="px-3 py-2 bg-neutral-50 dark:bg-neutral-950 border-b border-neutral-200 dark:border-neutral-800">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-1.5 text-xs">
            ...
            <span className="text-blue-600 dark:text-blue-400 font-mono">user</span>
        ...
        <div className="text-[10px] text-neutral-400 mt-0.5 ml-5.5">Created 2 hours ago</div>
      </div>
      ...
      <div className="flex-1 bg-white dark:bg-neutral-950">
        <div className="px-3 pt-2 pb-1">
          <span className="text-[10px] text-neutral-500">gists.sh showcase</span>
        </div>
        {/* Code file header */}
        <div className="mx-3 mt-1 rounded-t-md border border-neutral-200 dark:border-neutral-800">
          ...
          <div className="px-2 py-2 font-mono text-[11px] leading-[1.6] text-neutral-600 dark:text-neutral-400">
            ...
            {codeLine(
              2,
              <span className="text-green-700 dark:text-green-500">Minimal gist fetcher.</span>,
            )}
            {codeLine(
              3,
              <span className="text-green-700 dark:text-green-500">&quot;&quot;&quot;</span>,
            ...
            {codeLine(
              ...
              <>
                ...
                <span className="text-neutral-700 dark:text-neutral-300">httpx</span>
              </>,
            )}
            {codeLine(
              6,
              <>
                ...
                <span className="text-neutral-700 dark:text-neutral-300">dataclasses</span>{" "}
                <span className="text-purple-700 dark:text-purple-400">import</span>{" "}
                <span className="text-neutral-700 dark:text-neutral-300">dataclass</span>
              </>,
            )}
            {codeLine(7, "\u00A0")}
            {codeLine(
              8,
              <>
                <span className="text-red-700 dark:text-red-400">@dataclass</span>
              </>,
            )}
            {codeLine(
              9,
